...
import net.fustinoni.pi.robotRMI.component.FrontLedsRemoteImpl;
import net.fustinoni.pi.robotRMI.component.FrontalUltraSoundSensorRemoteImpl;
import net.fustinoni.pi.robotRMI.component.GenericSwitchRemoteImpl;
import net.fustinoni.pi.robotRMI.component.LineFollowareTwoSensorRemoteImpl;
import net.fustinoni.pi.robotRMI.component.RearLedsRemoteImpl;
import net.fustinoni.pi.robotRMI.component.SideIRSensorsRemoteImpl;
import net.fustinoni.pi.robotRMI.device.LedRemote;
import net.fustinoni.pi.robotRMI.device.MotorRemote;
import net.fustinoni.pi.robotRMI.device.MotorRemoteImpl;
import net.fustinoni.pi.robotRMI.device.ServoRemote;
import net.fustinoni.pi.robotRMI.device.ServoRemoteImpl;
import net.fustinoni.pi.robotRMI.sensor.IRSensorRemote;
import net.fustinoni.pi.robotRMI.sensor.SwitchRemote;
import net.fustinoni.pi.robotRMI.sensor.UltraSoundSensorRemote;
