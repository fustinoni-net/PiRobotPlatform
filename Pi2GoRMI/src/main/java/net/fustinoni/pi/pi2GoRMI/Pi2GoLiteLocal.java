...
import net.fustinoni.pi.robotRMI.device.LedLocal;
import net.fustinoni.pi.robotRMI.device.MotorLocal;
import net.fustinoni.pi.robotRMI.device.ServoLocal;
import net.fustinoni.pi.robotRMI.sensor.IRSensorLocal;
import net.fustinoni.pi.robotRMI.sensor.SwitchLocal;
import net.fustinoni.pi.robotRMI.sensor.UltraSoundSensorLocal;
