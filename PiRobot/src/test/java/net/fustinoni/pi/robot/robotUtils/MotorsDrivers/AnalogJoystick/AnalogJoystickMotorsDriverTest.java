 ...
 * @author efustinoni
 */
public class AnalogJoystickMotorsDriverTest {
    ...
    public AnalogJoystickMotorsDriverTest() {
...
//    }
    ...
    public void testJostickHalfForward() {
        ...
        for (int i = 0; i< xCenter.length; ++i){
            ...
            assert leftMotorSpeed < 52 && leftMotorSpeed > 48;
            //assertEquals(50, leftMotorSpeed);
            assertTrue(leftMotorisForward);
            assert rightMotorSpeed < 52 && rightMotorSpeed > 48;
            //assertEquals(50, rightMotorSpeed);
            assertTrue(rightMotorisForward);
        }
    }        
    ...
    public void testJostickHalfLeftHalfForward() {
        ...
        for (int i = 0; i< xCenter.length; ++i){
            ...
            assert leftMotorSpeed >= 24 && leftMotorSpeed < 26;
            assertTrue(leftMotorisForward);
            //assertEquals(50, rightMotorSpeed);
            assert rightMotorSpeed >= 49 && rightMotorSpeed < 51;
            assertTrue(rightMotorisForward);
    ...
    public void testJostickHalfRightHalfForward() {
        ...
        for (int i = 0; i< xCenter.length; ++i){
            ...
            //assertEquals(50, leftMotorSpeed);
            assert leftMotorSpeed >= 49 && leftMotorSpeed <= 51;
            assertTrue(leftMotorisForward);
            //assertEquals(25, rightMotorSpeed);
            assert rightMotorSpeed >= 24 && rightMotorSpeed <= 26;
            assertTrue(rightMotorisForward);
        }
    }
